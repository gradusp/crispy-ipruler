...
import (
	...
	"github.com/gradusp/crispy-ipruler/internal/app"
	"github.com/gradusp/crispy-ipruler/internal/config"
...
func main() {
	...
	err := config.InitGlobalConfig(
		config.WithAcceptEnvironment{EnvPrefix: "IPRULER"},
		...
		config.WithDefValue{Key: app.ServerEndpoint, Val: "tcp://127.0.0.1:9004"},
	)
	if err != nil {
